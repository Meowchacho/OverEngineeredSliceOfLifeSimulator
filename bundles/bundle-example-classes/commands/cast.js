...
module.exports = {
  command : state => (args, player) => {
    ...
    if (!match) {
      return BroadcastSystem.sayAt(player, "Casting spells must be surrounded in quotes e.g., cast 'fireball' target");
    }
    ...
    if (!spell) {
      return BroadcastSystem.sayAt(player, "No such spell.");
    }
